        ...
        <CardBody>
          <dl className="grid grid-cols-1 gap-4 text-sm sm:grid-cols-3">
            <div>
              ...
              <dd className="mt-1 font-medium text-slate-700">{payout.scheduledFor}</dd>
            </div>
            <div>
              <dt className="text-xs font-medium uppercase tracking-wider text-slate-500">
                Initiated
          ...
          {payout.failureReason !== null && (
            <p
              role="alert"
              className="mt-4 rounded-xl bg-rose-50 px-3 py-2 text-sm text-rose-700 ring-1 ring-inset ring-rose-200"
            >
                ...
                <tbody className="divide-y divide-slate-100">
                  {payout.orders.map((order) => (
                    <tr key={order.id} className="hover:bg-slate-50">
                      <td className="px-4 py-3 font-medium text-slate-700">{order.shortCode}</td>
