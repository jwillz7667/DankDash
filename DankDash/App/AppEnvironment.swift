...
/// session survives relaunches and refreshes silently — no Face ID, no
/// password. The 401-refresh path reads the in-memory cache first, then
/// the keychain non-interactively.
