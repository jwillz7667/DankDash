...
/// Reused from the consumer target unchanged — the 6-digit code field
/// carries the existing ``LoginFeature`` challenge so verifying lands
/// the same auth tokens as the happy path.
