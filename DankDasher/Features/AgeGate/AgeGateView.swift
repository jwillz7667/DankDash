...
/// renders. Reused verbatim from the consumer target so a fresh
/// driver install also lands the same statutory check (Minn. Stat.
/// § 342.27); the underlying ``AgeGateFeature`` is parent-agnostic
/// and lives in DankDashKit.
